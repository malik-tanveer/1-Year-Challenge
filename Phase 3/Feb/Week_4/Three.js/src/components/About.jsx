...
<div className="ab-layout flex items-start gap-12">
          ...
          <div 
  ref={imgRef} 
  className="ab-img-wrap relative flex-shrink-0 top-24"
  style={{ width: "min(320px,40vw)", opacity: 0 }}
>
...
<p
  ref={bioRef}
  className="leading-relaxed mb-6 text-[#0a0f2c]/52"
  style={{ fontSize: "clamp(0.82rem,1.4vw,0.92rem)", maxWidth: 460, opacity: 0 }}
>
  I’m Malik Tanveer, a MERN stack developer focused on building modern, responsive, and real-world web applications. I work with React, Next.js, Node.js, and databases like MongoDB and Supabase to create clean user interfaces and functional backend systems. I can build websites, dashboards, and full-stack applications from idea to working product. Currently, I’m focused on improving my skills and building better, more scalable projects. 
</p>

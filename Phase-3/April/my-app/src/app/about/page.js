  ...
  return (
    ...
    <div className="bg-white text-gray-900 min-h-screen font-sans">
      ...
      <section className="bg-gradient-to-t from-gray-100 to-white border-t py-16 text-center px-6">
        ...
        <Link href="/product" className="mt-6 inline-flex items-center gap-2 bg-black hover:bg-blue-600 text-white font-bold px-8 py-3.5 rounded-xl transition shadow-md">
